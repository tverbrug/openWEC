...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.sketchShape.setPixmap(QtGui.QPixmap(_fromUtf8("src/oyster_shape.png")))
        ...
        self.hoslLabel = QtGui.QLabel(self.tabMesh)
        self.hoslLabel.setObjectName(_fromUtf8("hoslLabel"))
        self.formLayout_3.setWidget(5, QtGui.QFormLayout.LabelRole, self.hoslLabel)
        self.hoslBox = QtGui.QLineEdit(self.tabMesh)
        self.hoslBox.setText(_fromUtf8(""))
        self.hoslBox.setObjectName(_fromUtf8("hoslBox"))
        self.formLayout_3.setWidget(5, QtGui.QFormLayout.FieldRole, self.hoslBox)
    ...
    def makeMesh(self,MainWindow):
        ...
        ne.createMeshOpt(hosb-waterDepth,nPanels,0,float(self.rhoBox.text()))
    ...
    def runNemohCode(self):
        ...
        (Mass,KH) = pn.calcM(rho=rhoW,dof=dof)
    ...
    def openFile(self):
        ...
        self.fdampBox.setText(inData[33].split('\t')[0])
