...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.sketchShape.setPixmap(QtGui.QPixmap(_fromUtf8("src/wavestar_shape.png")))
        ...
        self.formLayout_3.setWidget(3, QtGui.QFormLayout.LabelRole, self.genProp)
        self.diameterLabel = QtGui.QLabel(self.tabMesh)
        self.diameterLabel.setObjectName(_fromUtf8("diameterLabel"))
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.LabelRole, self.diameterLabel)
        self.diameterBox = QtGui.QLineEdit(self.tabMesh)
        self.diameterBox.setObjectName(_fromUtf8("diameterBox"))
        self.formLayout_3.setWidget(2, QtGui.QFormLayout.FieldRole, self.diameterBox)
        ...
        self.formLayout_3.setWidget(6, QtGui.QFormLayout.LabelRole, self.MeshProp)
        ...
        self.formLayout_3.setWidget(7, QtGui.QFormLayout.LabelRole, self.nPanelLabel)
        self.nPanelBox = QtGui.QLineEdit(self.tabMesh)
        self.nPanelBox.setObjectName(_fromUtf8("nPanelBox"))
        self.formLayout_3.setWidget(7, QtGui.QFormLayout.FieldRole, self.nPanelBox)
        ...
        self.formLayout_3.setWidget(8, QtGui.QFormLayout.FieldRole, self.meshButton)
    ...
    def openFile(self):
        ...
        self.fdampBox.setText(inData[30].split('\t')[0])
